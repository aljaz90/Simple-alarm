...
export const Alert = props => {
    ...
    if (props.type === "warning") {
        title = <React.Fragment>Warning <IonIcon icon="warning-outline" /></React.Fragment>;
        gradient = "linear-gradient(to left bottom, #ffa704, #8e44ad)";
    }
    else if (props.type === "error") {
        title = <React.Fragment>Error <IonIcon icon="close-circle-outline" /></React.Fragment>;
        gradient = "linear-gradient(to left bottom, #d80000, #8e44ad)";
    }
    else if (props.type === "success") {
        title = <React.Fragment>Success <IonIcon icon="checkmark-circle-outline" /></React.Fragment>;
            ...
            <div className="alert">
                ...
                <div className="alert--actions">
                    <div className={`flex--filler ${props.actions[1] ? "flex--align-right" : "flex--align-center"}`}>
                        <div onClick={() => onClick(0)} className="alert--actions--item alert--actions--item-important">
