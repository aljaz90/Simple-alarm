...
export const SidebarItem = props => {
    return (
        <div className={`sidebar--item ${props.disabled ? "sidebar--item-disabled" : ""}`}>
            <div className={`sidebar--item--background ${props.active ? "sidebar--item--background-selected" : ""}`}></div>
                {
                    props.to === "" ? 
                    ...
                    :
                        <NavLink activeClassName="sidebar--item--icon-selected" to={props.to} exact className="sidebar--item--icon">
                            <IonIcon className="sidebar--item--icon--icon" name={props.icon} />
                        </NavLink>
                }
